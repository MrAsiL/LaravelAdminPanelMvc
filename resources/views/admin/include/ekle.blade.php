@extends('admin.tema')
@section('admintitle') Ekleme İşlemleri Dvtsec Admin Template @endsection
@section('css')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="{{route('eklepost',$modullerBilgisi->seflink)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label>Sira No</label>
                                        <input type="number" class="form-control input-default" placeholder="Sira No " name="sirano" required>
                                    </div>
                                    <div class="form-group">
